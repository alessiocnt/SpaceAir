...
class Packet {
    ...
    public function __construct(int $code, $img, DateTime $departureDateHour, DateTime $arriveDateHour, float $price, int $maxSeats, string $description, int $destinationPlanet, bool $visible) {
        $this->code = $code;
        $this->img = $img;
