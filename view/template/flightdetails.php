    ...
    <section class="mb-3 col-10 offset-1 col-md-6 offset-md-3">
        <div class="row">
            ...
            <div class="col-12 px-0">
                ...
                <p class="font-weight-bold col-text my-0">Posti disponibili:<span class="float-right font-weight-normal"><?php echo $packet->getAviableSeats(); ?></span></p>
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control" name="inputQuantity" id="inputQuantity" value="1" min="0" max="<?=$packet->getAviableSeats();?>" step="1"/>
                    </div>
                </div>
                <div class="col-4">
