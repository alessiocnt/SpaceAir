                        ...
                        <div class="rounded my-2 col-back-white p-4 col-dark ">
                            <div class="row">
                                <div class="col-4 col-md-3">
                                    <img src="./res/upload/admin/<?=$interest->getPlanet()->getImgPlanet();?>" class="card-img mx-auto d-block interest-img" alt="">
                                </div>
                                <div class="col-8 col-md-9">
                                    <a href="#" class="btn-int" title="Rimuovi dai preferiti" id="<?=$interest->getPlanet()->getCodPlanet();?>">
                                        <img src="./res/icons/remove_favourite.svg" class="mw-25 float-right mr-md-1" style="width: 18px;" alt="Rimuovi dal carrello">
                                    </a>
