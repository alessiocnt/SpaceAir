...
<!--         <style>
    ...
    <main> 
        <img class="home-img img-fluid" src="/spaceair/res/Icons/home-shuttle.jpg" alt="Shuttle utilizzato per i viaggi.">
        <p class="col-text text-center">Viaggia con noi, lasciati ispirare dal nostro universo.</p>
    </main>
