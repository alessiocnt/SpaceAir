                    ...
                    <h2 class="mt-3 mb-3 col-text font-weight-light">Inserisci la tua recensione</h2>
                        <form action="">
                            <div class="row mb-3">
                                    ...
                                    <div class="col-4">
                                        <button class="btn float-right" type="button">
                                            <img src="/spaceair/res/icons/star_rate-white-18dp.svg" class="scale-x2 img-fluid" alt="star1">
                                        </button>
                                        <button class="btn float-right" type="button">
                                            <img src="/spaceair/res/icons/star_rate-white-18dp.svg" class="scale-x2 img-fluid" alt="star2">
                                        </button>
                                        <button class="btn float-right" type="button">
                                            <img src="/spaceair/res/icons/star_rate-white-18dp.svg" class="scale-x2 img-fluid" alt="star3">
                                        </button>
                                        <button class="btn float-right" type="button">
                                            <img src="/spaceair/res/icons/star_rate-white-18dp.svg" class="scale-x2 img-fluid" alt="star4">
                                        </button>
                                        <button class="btn float-right" type="button">
                                            <img src="/spaceair/res/icons/star_rate-white-18dp.svg" class="scale-x2 img-fluid" alt="star5">
                                        </button>
                                    </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="col-3 offset-9">
                                        <input type="submit" class="form-control" value="Pubblica"/>
                            </div>
                        </form>
